...
import { teamsBld } from './teamsBld';


import { teamsBldCustomBot } from './teamsBldCustomBot';
...
let bot = new teamsBld(new builder.ChatConnector(botSettings));
express.post('/api/messages', bot.Connector.listen());



// Custom bot
let customBot = new teamsBldCustomBot();
